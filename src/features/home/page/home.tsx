    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ padding: 10 }}>
          ...
          <FlatList showsHorizontalScrollIndicator={false} keyExtractor={(item)=>item.id.toString()} data={data} horizontal renderItem={(data) => <MovieItem movie={data.item} width={150} height={200}/> } />
          
          <StyledText fontSize={24} fontWeight='Bold' style={{ marginVertical: 10 }}>
            Popular
          </StyledText>
          
          <FlatList showsHorizontalScrollIndicator={false} keyExtractor={(item)=>item.id.toString()} data={data} horizontal renderItem={(data) => <MovieItem movie={data.item} width={120} height={200}/> } />
